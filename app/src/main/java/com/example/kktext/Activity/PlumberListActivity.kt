...
class PlumberListActivity : AppCompatActivity(), ApiResponseListner,
    GoogleApiClient.OnConnectionFailedListener,
    ConnectivityListener.ConnectivityReceiverListener {
    private lateinit var binding: ActivityClientListBinding
    private lateinit var mAllAdapter: PlumberListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.igToolbar.tvTitle.text = "All Plumber"
    ...
    fun apiUpdateClient( id: Int,doa: String, dob: String) {
        ...
        apiClient.progressView.showLoader()
        apiClient.getApiPostCall(ApiContants.updatePlumber, params)
    }
    fun handleClientList(data: List<InstallerBean.Data>) {
        binding.rcAllLead.layoutManager = LinearLayoutManager(this)
        mAllAdapter = PlumberListAdapter(this, data, object :
            RvPlumberListner {
        ...
        try {
            ...
            if (tag == ApiContants.getPlumber) {
                ...
                if (istallerBean.error==false) {
                    handleClientList(istallerBean.data)
                }
            }
            ...
            if (tag == ApiContants.updatePlumber) {
