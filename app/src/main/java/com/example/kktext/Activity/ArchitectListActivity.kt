...
class ArchitectListActivity : AppCompatActivity(), ApiResponseListner,
    GoogleApiClient.OnConnectionFailedListener,
    ConnectivityListener.ConnectivityReceiverListener {
    private lateinit var binding: ActivityClientListBinding
    private lateinit var mAllAdapter: ArchitectListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.igToolbar.tvTitle.text = "All Architect"
    ...
    fun apiUpdateClient( id: Int, doa: String, dob: String) {
        ...
        apiClient.progressView.showLoader()
        apiClient.getApiPostCall(ApiContants.updateArchitect, params)
    }

    fun handleClientList(data: List<ArchitectBean.Data>) {
        binding.rcAllLead.layoutManager = LinearLayoutManager(this)
        mAllAdapter = ArchitectListAdapter(this, data, object :
            RvPlumberListner {
        ...
        try {
            ...
            if (tag == ApiContants.getArchitect) {
                ...
                if (architectBean.error==false) {
                    handleClientList(architectBean.data)
                }
            }
            ...
            if (tag == ApiContants.updateArchitect) {
