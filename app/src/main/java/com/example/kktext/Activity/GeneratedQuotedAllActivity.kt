...
class GeneratedQuotedAllActivity : AppCompatActivity(), ApiResponseListner,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.igToolbar.tvTitle.text = "All Generated Quoted"
        ...
        apiGetGeneratedQuote()

    }

    fun apiGetGeneratedQuote() {
        SalesApp.isAddAccessToken = true
        apiClient = ApiController(this, this)
        val params = Utility.getParmMap()
        apiClient.progressView.showLoader()
        apiClient.getApiPostCall(ApiContants.GetGeneratedQuote, params)
    }

    fun handleAllGeneratedQuote(data: List<GenratedQuoteBean.Data>) {
        binding.rcAllLead.layoutManager = LinearLayoutManager(this)
        var mAdapter = AllGeneratedQuoteAdapter(this, data, intent.getStringExtra("leadStatus"), object :
    ...
    override fun success(tag: String?, jsonElement: JsonElement?) {
        try {
            ...
            if (tag == ApiContants.GetGeneratedQuote) {
                ...
                if (allGeneratedQuoteBean.error==false) {
                    handleAllGeneratedQuote(allGeneratedQuoteBean.data)
                }
            }
