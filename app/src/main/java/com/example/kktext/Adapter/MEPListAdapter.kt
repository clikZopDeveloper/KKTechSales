...
class MEPListAdapter(var context: Activity, var mlist: List<MEPBean.Data>, var rvClickListner: RvPlumberListner) : RecyclerView.Adapter<MEPListAdapter.MyViewHolder>(),
    Filterable {
    var mFilteredList: MutableList<MEPBean.Data> = mlist as MutableList<MEPBean.Data>
    var doa = ""
    var dob = ""
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence): FilterResults {
                ...
                if (charString.isEmpty()) {
                    mFilteredList = mlist as MutableList<MEPBean.Data>
                } else {
                    val filteredList = ArrayList<MEPBean.Data>()
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                mFilteredList = filterResults.values as ArrayList<MEPBean.Data>
