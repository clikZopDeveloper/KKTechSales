...
class DocumentListAdapter(var context: Activity, var list: List<LeadDetailBean.Data>, var rvClickListner: RvStatusClickListner) : RecyclerView.Adapter<DocumentListAdapter.MyViewHolder>(){
