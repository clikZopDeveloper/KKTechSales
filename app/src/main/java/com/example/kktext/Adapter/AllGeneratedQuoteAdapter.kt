...
class AllGeneratedQuoteAdapter(var context: Activity, var list: List<GenratedQuoteBean.Data>, var leadStatus:String?, var rvClickListner: RvStatusClickListner) : RecyclerView.Adapter<AllGeneratedQuoteAdapter.MyViewHolder>(){
      ...
      //      holder.itemView.visibility=View.GONE
        ...
        holder.ivEditLead.setOnClickListener {
            context.startActivityForResult(Intent(context, EditLeadActivity::class.java)
                ...
                .putExtra("way","AllGeneratedQuote")
            ,101)
        }
