...
class ClientListAdapter(
    ...
    var mlist: List<ClientBean.Data>,
    var rvClickListner: RvPlumberListner
) : RecyclerView.Adapter<ClientListAdapter.MyViewHolder>(),
    Filterable {
    var mFilteredList: MutableList<ClientBean.Data> = mlist as MutableList<ClientBean.Data>
    var doa = ""
    var dob = ""
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.ivEditClient.setOnClickListener {
            rvClickListner.clickPos(
                ...
                mFilteredList.get(position).doa,
                mFilteredList.get(position).dob
            )
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence): FilterResults {
                ...
                if (charString.isEmpty()) {
                    mFilteredList = mlist as MutableList<ClientBean.Data>
                } else {
                    val filteredList = ArrayList<ClientBean.Data>()
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                mFilteredList = filterResults.values as ArrayList<ClientBean.Data>
